...
use ui::{ButtonLike, KeyBinding, ListItem, ListItemSpacing, Tooltip, l10n, prelude::*};
...
impl PickerDelegate for SidebarRecentProjectsDelegate {
    ...
    fn placeholder_text(&self, _window: &mut Window, _cx: &mut App) -> Arc<str> {
        l10n::text("Search recent projects…").into()
    }
                    ...
                    ButtonLike::new("open_local_folder")
                        .child(
                            h_flex()
                                ...
                                .gap_1()
                                .justify_between()
                                .child(Label::new(l10n::text("Add Local Folders")))
                    ...
                    ButtonLike::new("open_remote_folder")
                        .child(
                            h_flex()
                                ...
                                .gap_1()
                                .justify_between()
                                .child(Label::new(l10n::text("Add Remote Folder")))
