...
use ui::{
    ...
    ScrollableHandle, StatefulInteractiveElement, Tooltip, WithScrollbar, l10n, prelude::*,
};
    ...
    fn change_query_bar_mode(
        ...
        if !self.is_writing_memory {
            self.query_editor.update(cx, |this, cx| {
                ...
                this.set_placeholder_text(l10n::text("Write to Selected Memory Range"), window, cx);
            });
            ...
            self.query_editor.update(cx, |this, cx| {
                ...
                this.set_placeholder_text(
                    l10n::text("Go to Memory Address / Expression"),
                    window,
                    cx,
                );
            });
