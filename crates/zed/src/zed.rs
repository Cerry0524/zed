...
use ui::{Navigable, NavigableEntry, PopoverMenuHandle, TintColor, l10n, prelude::*};
                        ...
                        h_flex()
                            ...
                            .child(
                                div()
                                    ...
                                    .child(
                                        Button::new("copy", l10n::text("Copy"))
                                            .full_width()
