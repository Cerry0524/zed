...
use ui::{HighlightedLabel, KeyBinding, ListItem, ListItemSpacing, l10n, prelude::*};
use util::ResultExt;
...
impl PickerDelegate for CommandPaletteDelegate {
    ...
    fn render_footer(
        ...
        let keybinding_buttons = if keybind.has_binding(window) {
            Button::new("change", l10n::text("Change Keybinding…"))
                .key_binding(
            ...
            Button::new("add", l10n::text("Add Keybinding…"))
                .key_binding(
                    KeyBinding::for_action_in(&menu::SecondaryConfirm, focus_handle, cx)
                        .map(|kb| kb.size(rems_from_px(12.))),
                )
        ...
        Some(
            h_flex()
                ...
                .child(
                    Button::new("run-action", l10n::text("Run"))
                        .key_binding(
