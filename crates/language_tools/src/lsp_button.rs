...
use ui::{
    ContextMenu, ContextMenuEntry, Indicator, PopoverMenu, PopoverMenuHandle, Tooltip, l10n,
    prelude::*,
};
                ...
                status_color,
                {
                    ...
                    move |menu, _window, _cx| {
                        ...
                        if has_logs {
                            ...
                            submenu =
                                submenu.entry(l10n::text("View Logs"), None, move |window, cx| {
                                    lsp_log_view::open(
                                        &lsp_logs_for_debug,
